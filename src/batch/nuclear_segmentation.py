...
def segment_objects_stardist2d(image_dir, output_dir_labels,output_dir_ijroi,use_pretrained=False,model_dir='models', model_name='DAPI_segmenation', prob_thresh=0.6, normalize_quants=[1, 99.8]):
    ...
    for i in range(len(all_images)):
            ...
            labels, polygons = model.predict_instances(X,n_tiles=model._guess_n_tiles(X),prob_thresh=prob_thresh)
